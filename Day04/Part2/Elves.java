public class Elves {
    public static void main(String[] args) {
        ...
        for (RangePair rp : apl.getRangePairs()) {
            ...
            if ((rp.getRange1().getHi() < rp.getRange2().getLo()) ||
                (rp.getRange1().getLo() > rp.getRange2().getHi()) ||
                (rp.getRange2().getHi() < rp.getRange1().getLo()) ||
                (rp.getRange2().getLo() > rp.getRange1().getHi())) {
